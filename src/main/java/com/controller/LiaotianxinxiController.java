...
public class LiaotianxinxiController {
     ...
     */
    @RequestMapping("/page")
    public R page(@RequestParam Map<String, Object> params,LiaotianxinxiEntity liaotianxinxi,
		HttpServletRequest request){
		String tableName = request.getSession().getAttribute("tableName").toString();
		if(tableName.equals("jiaolian")) {
			liaotianxinxi.setJiaolianbianhao((String)request.getSession().getAttribute("username"));
		}
	...
	@IgnoreAuth
    @RequestMapping("/list")
    public R list(@RequestParam Map<String, Object> params,LiaotianxinxiEntity liaotianxinxi, 
		HttpServletRequest request){
        EntityWrapper<LiaotianxinxiEntity> ew = new EntityWrapper<LiaotianxinxiEntity>();
		PageUtils page = liaotianxinxiService.queryPage(params, MPUtil.sort(MPUtil.between(MPUtil.likeOrEq(ew, liaotianxinxi), params), params));
        return R.ok().put("data", page);
