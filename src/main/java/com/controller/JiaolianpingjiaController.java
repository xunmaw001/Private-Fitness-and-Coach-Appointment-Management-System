...
public class JiaolianpingjiaController {
    ...
    public R page(@RequestParam Map<String, Object> params,JiaolianpingjiaEntity jiaolianpingjia,
		...
		if(tableName.equals("jiaolian")) {
			jiaolianpingjia.setJiaolianbianhao((String)request.getSession().getAttribute("username"));
		}
		if(tableName.equals("yonghu")) {
			jiaolianpingjia.setZhanghao((String)request.getSession().getAttribute("username"));
		}
