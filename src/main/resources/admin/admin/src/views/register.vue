<template>
  <div>
      ...
      <div class="login-form">
        <h1 class="h1">私人健身与教练预约管理系统注册</h1>
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm">
			...
			<!-- <div v-if="tableName=='jiaolian'" class="input-group">
			   <div class="label">教练编号</div>
			   <div class="input-container">
			     <input v-model="ruleForm.jiaolianbianhao" class="input" type="text" placeholder="教练编号">
			   </div>
			 </div> -->
			<el-form-item label="教练编号" class="input" v-if="tableName=='jiaolian'">
			  <el-input v-model="ruleForm.jiaolianbianhao" autocomplete="off" placeholder="教练编号"  />
			</el-form-item>
			<!-- <div v-if="tableName=='jiaolian'" class="input-group">
			   <div class="label">密码</div>
			   <div class="input-container">
			...
			<!-- <div v-if="tableName=='jiaolian'" class="input-group">
			   ...
			   <div class="input-container">
			     <input v-model="ruleForm.jiaoliandengji" class="input" type="text" placeholder="教练等级">
			   </div>
			 </div> -->
			<el-form-item label="教练等级" class="input" v-if="tableName=='jiaolian'">
			  <el-input v-model="ruleForm.jiaoliandengji" autocomplete="off" placeholder="教练等级"  />
			</el-form-item>
			<!-- <div v-if="tableName=='jiaolian'" class="input-group">
...
export default {
  ...
  methods: {
	...
	var url=this.tableName+"/register";
      ...
      if((!this.ruleForm.jiaolianbianhao) && `jiaolian` == this.tableName){
