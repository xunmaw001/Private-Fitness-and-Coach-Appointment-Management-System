<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="评星" prop="pingxing">
          <el-select :disabled="ro.pingxing" v-model="ruleForm.pingxing" placeholder="请选择评星">
            <el-option
                v-for="(item,index) in pingxingOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          <el-form-item class="input" label="评星" prop="pingxing">
	      <el-input v-model="ruleForm.pingxing"
                placeholder="评星" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.jiaolianxingming = true;
          ...
          if(o=='pingxing'){
            this.ruleForm.pingxing = obj[o];
	    this.ro.pingxing = true;
            continue;
          }
          if(o=='pingjia'){
