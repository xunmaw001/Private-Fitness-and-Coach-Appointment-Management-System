<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="24">  
        <el-form-item class="upload" v-if="type!='info'&& !ro.jianshenshipin" label="健身视频" prop="jianshenshipin">
          <file-upload
          tip="点击上传健身视频"
          action="file/upload"
          :limit="1"
          :multiple="true"
          :fileUrls="ruleForm.jianshenshipin?ruleForm.jianshenshipin:''"
          @change="jianshenshipinUploadChange"
          ></file-upload>
        </el-form-item> 
        <div v-else>
          <el-form-item v-if="ruleForm.jianshenshipin" label="健身视频" prop="jianshenshipin">
            <el-button type="text" size="small" @click="download($base.url+ruleForm.jianshenshipin)">预览</el-button>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="24">  
...
export default {
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.jianshenxiaoguo = true;
          ...
          if(o=='jianshenshipin'){
            this.ruleForm.jianshenshipin = obj[o];
	    this.ro.jianshenshipin = true;
            continue;
          }
          if(o=='xiangmujieshao'){
      ...
      this.$http({
        ...
        if (data && data.code === 0) {
          ...
          this.$message.error(data.msg);
            ...
            this.$http({
              url: `option/xiangmufenlei/leixing`,
              method: "get"
            }).then(({ data }) => {
              if (data && data.code === 0) {
	...
	this.ruleForm.xiangmujieshao = this.ruleForm.xiangmujieshao.replace(reg,'../../../springboot6hv37/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
	...
	if(this.ruleForm.jianshenshipin!=null) {
		this.ruleForm.jianshenshipin = this.ruleForm.jianshenshipin.replace(new RegExp(this.$base.url,"g"),"");
	}
...
var objcross = this.$storage.getObj('crossObj');
    ...
    jianshenshipinUploadChange(fileUrls) {
	this.ruleForm.jianshenshipin = fileUrls;
	this.addEditUploadStyleChange()
    },
