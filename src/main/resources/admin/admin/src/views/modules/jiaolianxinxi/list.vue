        ...
        <el-table class="tables" :size="contents.tableSize" :show-header="contents.tableShowHeader"
		    ...
		    label="预约状态">
		     <template slot-scope="scope">
                  ...
                  <el-table-column :sortable="contents.tableSortable" :align="contents.tableAlign"  prop="jiaoliantupian"
                   :header-align="contents.tableAlign"
                    width="200"
                    label="教练图片">
                    <template slot-scope="scope">
                      <div v-if="scope.row.jiaoliantupian">
                        <img :src="$base.url+scope.row.jiaoliantupian.split(',')[0]" width="100" height="100">
                      </div>
                      <div v-else>无图片</div>
                    </template>
                  </el-table-column>
            <el-table-column width="300" :align="contents.tableAlign" 
               :header-align="contents.tableAlign"
                ...
                <el-button v-if="isAuth('jiaolianxinxi','预约') && contents.tableBtnIcon == 1 && contents.tableBtnIconPosition == 1" type="success" icon="el-icon-tickets" size="mini" @click="jiaolianyuyueCrossAddOrUpdateHandler(scope.row,'cross','','yuyuezhuangtai','繁忙中','繁忙,空闲'.split(',')[0])">{{ contents.tableBtnFont == 1?'预约':'' }}</el-button>
                <el-button v-if="isAuth('jiaolianxinxi','预约') && contents.tableBtnIcon == 1 && contents.tableBtnIconPosition == 2" type="success" size="mini" @click="jiaolianyuyueCrossAddOrUpdateHandler(scope.row,'cross','','yuyuezhuangtai','繁忙中','繁忙,空闲'.split(',')[0])">{{ contents.tableBtnFont == 1?'预约':'' }}<i class="el-icon-tickets el-icon--right" /></el-button>
                <el-button v-if="isAuth('jiaolianxinxi','预约') && contents.tableBtnIcon == 0" type="success" size="mini" @click="jiaolianyuyueCrossAddOrUpdateHandler(scope.row,'cross','','yuyuezhuangtai','繁忙中','繁忙,空闲'.split(',')[0])">{{ contents.tableBtnFont == 1?'预约':'' }}</el-button>
